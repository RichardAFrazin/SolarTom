...
#define LAMBDA  { 1.0 , 1.0, 1.e-5}             // LAMBDA and HUBER_FLAG should have NMATS elements. Extra elements are ignored.
#define HUBER_FLAG {0, 0, 0}
#define FILESTR0 "wisprI.512.Orbit24.60images"                        // A_outfile of first A matrix
#define FILESTR1 "wisprO.512.Orbit24.60images"                        // A_outfile of second A matrix, or first Reg matrix
//#define FILESTR1 "hlaplac_26_90_180"     // Must always be specified.
#define FILESTR2 "hlaplac_100_90_180"      // Must always be specified.
#define MAIN_X_INFILE  "x_AWSOM_CR2081run5_WISPR_sphere_2.dat"
#define MAIN_X_OUTFILE "x_wisprIO.512.Orbit24.60images_l1e-5"
