...
#define INSTR_RMIN    2.// 3. // 20.  /* Set as the range of radii that overlap over the whole image series over a full 0.5AU->0.5AU orbit*/
#define INSTR_RMAX    2.19//8.25//8. // 30.  /* Right now I set the range that coresponds to Orbit 1. This is not possible for all orbits and/or both instruments. */
