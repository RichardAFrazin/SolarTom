...
#ifdef ORBIT_URL
#define WGETCOMMAND "/sw/bin/wget --quiet -P"  /* put the wget binary and path */
#endif
...
void build_subA_DR(char *, double, rcs_llist *, float **, float **, int *, FILE *, FILE *);
double differential_rotation_fcn(double, double, double, double, double *);
